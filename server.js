...
async function fetchPluginData(previousData, attempt = 1) {
    ...
    try {
        ...
        const url3 = 'https://www.figma.com/community/search?resource_type=plugins&sort_by=relevancy&query=zeplin+team+across&editor_type=all&price=all&creators=all';
...
async function fetchPageData(url, previousData) {
    ...
    try {
        ...
        await page.waitForSelector('.plugin_row--pluginRow--lySkC', { timeout: 3000 });
